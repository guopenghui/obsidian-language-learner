<template>
    <div class="container" ref="panel">
        ...
        <button v-for="sub in ['柯林斯', '辨析', '例句', '句酷']" @click="curPanel = sub" :style="curPanel===sub?'background-color:#483699;color:white;':''">{{sub}}</button>
        <Collins class="collins" v-if="curPanel==='柯林斯'" :mydata="collins"/>
        <!--<div class="collins" v-html="collinsHTML" v-if="subPanel==='柯林斯'"></div>-->
